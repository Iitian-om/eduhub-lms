      ...
      <div className="px-4 pt-10 sm:px-6 lg:px-8">
        <div className="mx-auto mb-8 max-w-6xl rounded-3xl border border-[#CFE9EA] bg-gradient-to-br from-[#EAF8F8] via-white to-[#ECF6FF] px-6 py-10 shadow-sm">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              <h1 className="text-4xl font-bold mb-2 text-[#1B2A33]">Research Papers Library</h1>
            ...
            {user && (user.role === 'Admin' || user.role === 'Instructor' || user.role === 'Mod') && (
              <Link
                ...
                className="bg-[#29C7C9] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#22b6b7] transition flex items-center shadow-sm"
              >
                <svg
        ...
        {!loading && !error && papers.length > 0 && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
              {papers.map((paper) => (
                <div key={paper._id} className="bg-white rounded-2xl shadow-sm overflow-hidden hover:shadow-md transition-shadow flex flex-col border border-[#D7ECEE]">
                  ...
                  <div className="relative pt-3">
                    ...
                    <div className="px-5 mb-3">
                      ...
                      <h2 className="text-xl font-bold text-[#1B2A33] line-clamp-2">{paper.title}</h2>
                  ...
                  <div className="p-5 flex-grow">
                    <p className="text-[#4A6572] text-sm mb-4 line-clamp-3">{paper.abstract}</p>
                    ...
                    {/* Journal info */}
                    {paper.journal && (
                      <div className="text-sm text-[#4A6572] mb-2 flex items-center">
