      ...
      <div className="px-4 pt-10 sm:px-6 lg:px-8">
        <div className="mx-auto mb-8 max-w-6xl rounded-3xl border border-[#CFE9EA] bg-gradient-to-br from-[#EAF8F8] via-white to-[#ECF6FF] px-6 py-10 shadow-sm">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div>
              <h1 className="text-4xl font-bold mb-2 text-[#1B2A33]">Books Library</h1>
        ...
        {!loading && !error && books.length > 0 && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
              {books.map((book) => (
                <div key={book._id} className="bg-white rounded-2xl shadow-sm overflow-hidden hover:shadow-md transition-shadow flex flex-col border border-[#D7ECEE]">
                  ...
                  <div className="relative pt-3">
                    ...
                    <div className="px-5 mb-3">
                      ...
                      <h2 className="text-xl font-bold text-[#1B2A33] line-clamp-1">{book.title}</h2>
                      <p className="text-[#4A6572] text-sm">By {book.author}</p>
                    </div>
                  </div>
                  
                  {/* Book content */}
                  <div className="p-5 flex-grow">
                    <p className="text-[#4A6572] text-sm mb-4 line-clamp-3">{book.description}</p>
                    ...
                    <div className="text-xs text-[#6A808A] space-y-1">
                  ...
                  <div className="px-5 py-4 bg-[#F8FEFE] border-t border-[#D7ECEE]">
                    ...
                    {user && (user.role === "Admin" || user.role === "Mod" || (user.role === "Instructor" && book.uploadedBy?._id === user._id)) && (
